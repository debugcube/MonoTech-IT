        ...
        <div>
            ...
            <div className="navbar bg-blue-500 text-white my-8" >
                <div className="flex-1">
                    <a href="/Dashboard" className="btn btn-ghost text-xl ">Email Marketing Platform</a>
                </div>
                <div className="flex-none ">
                    ...
                    <div className="dropdown dropdown-end z-10">
                        ...
                        <ul tabIndex={0} className="menu bg-white menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52 text-black">
                            <li>
